#if (defined(USE_XCTEST_PUBLIC_HEADERS) && USE_XCTEST_PUBLIC_HEADERS) || !__has_include(<XCTestCore/XCUIElementTypeQueryProvider.h>)
//
...
#else
#import <XCTestCore/XCUIElementTypeQueryProvider.h>
#endif
